 ...
 */
BroadPeakWave::BroadPeakWave(const std::vector<double> &times, 
 ...
 */
double BroadPeakWave::fluxPhase(double phase, double amp) const {
	return 1 + amp*(-0.25 + 0.625/(1.5 + sin(2*M_PI*phase)));
}
